...
<div class="h-[66px] w-full rounded-md border border-border bg-secondary">
	...
	<div class="flex w-full flex-grow flex-col pb-[12px] pr-[12px]">
		<div class="flex h-[24px] w-full flex-none flex-row pl-[8px] text-[12px] text-font-secondary">
			...
			<div class="ml-auto flex aspect-square h-full flex-none">
				<button
					class="h-full w-full rounded p-1 text-font-secondary outline-none transition-colors duration-150 ease-linear hover:bg-primary focus:outline-none"
					type="button"
